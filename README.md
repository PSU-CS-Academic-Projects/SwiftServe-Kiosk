...
### Contributors
- **Castillo, Kenneth Vincent** (Project Lead / Lead Developer)
- **Malate, Juan Miguel** (Frontend Developer / UI Designer)
- **Padrones, Kim Andrei** (Quality Assurance / Database Designer)
